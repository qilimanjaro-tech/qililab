...
class SNZ(PulseShape):
    ...
    name: PulseShapeName = PulseShapeName.SNZ  #: Name of the snz pulse shape.
    b: float  # type: ignore[misc]  #: Instant stops height.
    t_phi: int  # type: ignore[misc]  #: Time at `height = 0`.
