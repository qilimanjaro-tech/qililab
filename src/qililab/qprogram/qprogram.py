...
class QProgram(StructuredProgram):
    ...
    Examples:
        ...
        .. code-block:: python3
            ...
            from qililab import QProgram, Domain, IQDrag, Square
            ...
            readout_wf = IQDrag(I=Square(amplitude=1.0, duration=400), Q=Square(amplitude=0.0, duration=400))

            # Weights used during integration
            weights = IQDrag(I=Square(amplitude=1.0, duration=2000), Q=Square(amplitude=1.0, duration=2000))
