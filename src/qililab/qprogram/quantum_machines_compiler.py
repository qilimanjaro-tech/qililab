...
class QuantumMachinesCompiler:
    ...
    def _handle_play(self, element: Play):
        ...
        if not waveform_variables:
            waveform_I_name = self.__add_waveform_to_configuration(waveform_I, False)
            waveform_Q_name = self.__add_waveform_to_configuration(waveform_Q, False) if waveform_Q else None
