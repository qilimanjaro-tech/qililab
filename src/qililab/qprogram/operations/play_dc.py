...
@yaml.register_class
class PlayDC(Operation):
    def __init__(self, bus: str, waveform: Waveform) -> None:
        super().__init__()
        self.bus: str = bus
...
@yaml.register_class
class PlayDCWithCalibratedWaveform(Operation):
    def __init__(self, bus: str, waveform: str) -> None:
        super().__init__()
        self.bus: str = bus
