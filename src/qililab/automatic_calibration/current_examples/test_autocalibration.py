...
first = CalibrationNode(
    nb_path="notebooks/first.ipynb", in_spec_threshold=0.1, bad_data_threshold=0.2, drift_timeout=1800.0
)
second = CalibrationNode(
    nb_path="notebooks/second.ipynb", in_spec_threshold=0.1, bad_data_threshold=0.2, drift_timeout=1.0
)
third = CalibrationNode(
    nb_path="notebooks/third.ipynb", in_spec_threshold=0.1, bad_data_threshold=0.2, drift_timeout=1.0
)
