...
class Platform:
    ...
    def draw(self, qprogram: QProgram, timeout: int = None, averages_displayed: bool = False):
        ...
        result = qblox_draw.draw(sequencer, runcard_data, timeout, averages_displayed)
