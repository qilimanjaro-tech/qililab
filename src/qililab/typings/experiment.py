...
class ExperimentOptions:
    ...
    def to_dict(self):
        ...
        return {
            ...
            RUNCARD.TRANSPILATION_SETTINGS: asdict(self.settings),
    ...
    def from_dict(cls, dictionary: dict):
        ...
        return ExperimentOptions(
            loops=loops,
            settings=ExperimentSettings(**dictionary[RUNCARD.TRANSPILATION_SETTINGS])
            if RUNCARD.TRANSPILATION_SETTINGS in dictionary
