...
def fixture_platform(chip: Chip) -> Platform:
    ...
    settings = RuncardSchema.PlatformSettings(  # type: ignore # pylint: disable=missing-kwoa, unexpected-keyword-arg
        **settings
    )
...
def fixture_chip():
   ...
   0,6,3 1,3,6
    ...
    settings = {
        "nodes": [
            {"name": "port", "alias": "feedline_input", "line": "feedline_input", "nodes": [3]},
            {
                "name": "qubit",
                "alias": "q0",
                "qubit_index": 0,
                "frequency": 6e9,
                "nodes": ["q2", "drive_line_q0", "flux_line_q0", "resonator_q0"],
            },
            {
                "name": "qubit",
                "alias": "q2",
                "qubit_index": 2,
                "frequency": 5e9,
                "nodes": ["q0", "q1", "q3", "q4", "drive_line_q2", "flux_line_q2", "resonator_q2"],
            },
            {
                "name": "qubit",
                "alias": "q1",
                "qubit_index": 1,
                "frequency": 4e9,
                "nodes": ["q2", "drive_line_q1", "flux_line_q1", "resonator_q1"],
            },
            {
                "name": "qubit",
                "alias": "q3",
                "qubit_index": 3,
                "frequency": 3e9,
                "nodes": ["q2", "drive_line_q3", "flux_line_q3", "resonator_q3"],
            },
            {
                "name": "qubit",
                "alias": "q4",
                "qubit_index": 4,
                "frequency": 4e9,
                "nodes": ["q2", "drive_line_q4", "flux_line_q4", "resonator_q4"],
            },
            {
                "name": "port",
                "line": "drive",
            ...
            },
            {
                ...
                "nodes": ["feedline_input", "q0"],
            },
            {
                "name": "resonator",
                "alias": "resonator_q1",
                "frequency": 8072600000,
                "nodes": ["feedline_input", "q1"],
            },
            {
                "name": "resonator",
                "alias": "resonator_q2",
                "frequency": 8072600000,
                "nodes": ["feedline_input", "q2"],
            },
            {
                "name": "resonator",
                "alias": "resonator_q3",
                "frequency": 8072600000,
                "nodes": ["feedline_input", "q3"],
            },
            {
                "name": "resonator",
                "alias": "resonator_q4",
                "frequency": 8072600000,
                "nodes": ["feedline_input", "q4"],
            },
        ],
    }
    ...
    [
        ...
        (
            [Drag(4, np.pi, 3 * np.pi / 2), gates.CZ(0, 2), gates.M(2)],
            {
                ...
                "nodes": ["drive_line_q4", "flux_line_q0", "feedline_input"],
            },
        ),
        (
            [Drag(2, 1, 1), Drag(4, 2, 1), gates.CZ(0, 2), gates.M(1)],
            {
                ...
                "nodes": ["drive_line_q2", "drive_line_q4", "flux_line_q0", "feedline_input"],
            },
        ),
        (
            [
