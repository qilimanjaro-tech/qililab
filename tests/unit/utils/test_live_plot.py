...
class TestLivePlot:
    ...
    def test_live_plot_ranges_with_one_loop(self, connection: API, one_loop: Loop):
        ...
        assert len(list(plot.x_iterator_ranges)) == len(one_loop.values)
    ...
    def test_live_plot_ranges_with_two_loops(self, connection: API, one_loop: Loop):
        ...
        assert len(list(plot.x_iterator_ranges)) == len(one_loop.values) * len(loop.values)
        assert len(list(plot.y_iterator_ranges)) == len(one_loop.values) * len(loop.values)
