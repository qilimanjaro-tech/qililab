...
class TestAttributes:
    ...
    def test_platform_attributes(self, experiment: Exp):
...
def fixture_experiment_all_platforms(request: pytest.FixtureRequest):
    ...
    experiment = Exp(platform=platform)
    mock_load.assert_called()
    return experiment
...
class TestMethods:
    ...
    def test_connect(self, experiment_all_platforms: Exp):
    ...
    def test_initial_setup(self, experiment_all_platforms: Exp):
    ...
    def test_build_execution(self, experiment: Exp):
    ...
    def test_compile(self, experiment: Exp):
    ...
    def test_compile_raises_error(self, experiment: Exp):
    ...
    def test_run_without_data_path_raises_error(self, experiment: Exp):
    ...
    def test_run(self, connected_experiment: Exp):
        ...
        with patch("qililab.execution.open") as mock_open:
            with patch("qililab.experiment.exp.open") as mock_open:
                with patch("qililab.experiment.exp.os.makedirs") as mock_makedirs:
                    with patch("qililab.experiment.exp.LivePlot") as mock_plot:
                        # Build execution
    ...
    def test_run_raises_error(self, experiment: Exp):
    ...
    def test_turn_on_instruments(self, connected_experiment: Exp):
    ...
    def test_turn_on_instruments_raises_error(self, experiment: Exp):
    ...
    def test_turn_off_instruments(self, connected_experiment: Exp):
    ...
    def test_turn_off_instruments_raises_error(self, experiment: Exp):
    ...
    def test_disconnect(self, experiment: Exp):
    ...
    def test_to_dict_method(self, experiment_all_platforms: Exp):
        """Test to_dict method."""
        dictionary = experiment_all_platforms.to_dict()
        assert isinstance(dictionary, dict)

    def test_from_dict_method(self, experiment: Exp):
        # sourcery skip: class-extract-method
        """Test from_dict method."""
        dictionary = experiment.to_dict()
        experiment_2 = Exp.from_dict(dictionary)
        assert isinstance(experiment_2, Exp)

    def test_from_dict_method_loop(self, nested_experiment: Exp):
        """Test from_dict method with an experiment with a nested loop."""
        dictionary = nested_experiment.to_dict()
        experiment_2 = Exp.from_dict(dictionary)
        assert isinstance(experiment_2, Exp)

    def test_draw_method(self, connected_experiment: Exp):
        """Test draw method."""
        connected_experiment.build_execution()
        figure = connected_experiment.draw()
        assert isinstance(figure, Figure)

    def test_draw_raises_error(self, experiment: Exp):
    ...
    def test_loop_num_loops_property(self, experiment_all_platforms: Exp):
    ...
    def test_draw_method_with_one_bus(self, experiment: Exp):
...
class TestSetParameter:
    ...
    def test_set_parameter_method_without_a_connected_device(self, experiment: Exp):
    ...
    def test_set_parameter_method_with_a_connected_device(
        ...
        mock_rs: MagicMock,
        mock_pulsar: MagicMock,
        experiment: Exp,  # pylint: disable=unused-argument
    ):
    ...
    def test_set_parameter_method_with_platform_settings(self, experiment: Exp):
    ...
    def test_set_parameter_method_with_instrument_controller_reset(self, experiment: Exp):
    ...
    def test_set_parameter_method_with_gate_value(self, experiment: Exp):
...
def fixture_experiment_reset(request: pytest.FixtureRequest):
    ...
    experiment = Exp(platform=platform, options=options)
    mock_load.assert_called()
    return experiment
...
class TestReset:
    ...
    def test_set_reset_false_with_connected_device(
        ...
        mock_rs: MagicMock,
        mock_pulsar: MagicMock,
        experiment_reset: Exp,  # pylint: disable=unused-argument
    ):
        """Test set reset to false method."""
        # add dynamically created attributes
        mock_instruments(mock_rs=mock_rs, mock_pulsar=mock_pulsar, mock_keithley=mock_keithley)
...
def fixture_simulated_experiment(simulated_platform: Platform):
    """Return Experiment object."""
    return Exp(platform=simulated_platform)
