...
class TestAttributes:
    ...
    def test_platform_attributes(self, exp: Exp):
...
class TestMethods:
    ...
    def test_build_execution(self, exp: Exp):
    ...
    def test_run_without_data_path_raises_error(self, exp: Exp):
    ...
    def test_run_raises_error(self, exp: Exp):
    ...
    def test_turn_on_instruments_raises_error(self, exp: Exp):
    ...
    def test_turn_off_instruments_raises_error(self, exp: Exp):
    ...
    def test_disconnect(self, exp: Exp):
    ...
    def test_from_dict_method(self, exp: Exp):
...
class TestSetParameter:
    ...
    def test_set_parameter_method_without_a_connected_device(self, exp: Exp):
    ...
    def test_set_parameter_method_with_a_connected_device(
        ...
        mock_rs: MagicMock,
        mock_pulsar: MagicMock,
        exp: Exp,  # pylint: disable=unused-argument
    ):
    ...
    def test_set_parameter_method_with_platform_settings(self, exp: Exp):
    ...
    def test_set_parameter_method_with_instrument_controller_reset(self, exp: Exp):
    ...
    def test_set_parameter_method_with_gate_value(self, exp: Exp):
