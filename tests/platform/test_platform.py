...
class TestMethods:
    ...
    #         _ = platform.compile(circuit=circuit, num_avg=1000, repetition_duration=200_000, num_bins=1)
    ...
    #         platform.compile(circuit=circuit, num_avg=1000, repetition_duration=200_000, num_bins=1)
    ...
    #                         circuit=pulse_schedule, num_avg=1000, repetition_duration=2000, num_bins=1
    #                     )
    ...
    #                     acquire_result.return_value = qblox_result
    #                     _ = platform.execute(
    #                         circuit=pulse_schedule, num_avg=1000, repetition_duration=2000, num_bins=1, queue=queue
    #                     )
    ...
    #     # Define circuit
    #     c = Circuit(2)
    #     c.add([M(1), M(0), M(0, 1)])  # without ordering, these are retrieved for each sequencer, so
    ...
    #                         )
    #                         result = platform.execute(circuit=c, num_avg=1000, repetition_duration=2000, num_bins=1)
    ...
    #                     with pytest.raises(ValueError, match=error_string):
    #                         _ = platform.execute(circuit=c, num_avg=1000, repetition_duration=20_000, num_bins=1)
    ...
    #     # Define circuit
    #     c = Circuit(2)
    #     c.add([M(1), M(0, 1)])  # without ordering, these are retrieved for each sequencer, so
    #     # the order from qblox qrm will be M(0),M(1),M(1)
    #     n_m = len([qubit for gate in c.queue for qubit in gate.qubits if isinstance(gate, M)])
    ...
    #                     with pytest.raises(ValueError, match=error_string):
    #                         _ = platform.execute(circuit=c, num_avg=1000, repetition_duration=2000, num_bins=1)
    ...
    #         ),
    #     ):
    #         platform.execute(circuit=program, num_avg=1000, repetition_duration=2000, num_bins=1)
