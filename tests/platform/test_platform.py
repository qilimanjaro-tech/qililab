...
class TestPlatform:
    ...
    def test_id_property(self, platform: Platform):
        """Test id property."""
        assert platform.id_ == platform.gates.id_

    def test_name_property(self, platform: Platform):
        """Test name property."""
        assert platform.name == platform.gates.name

    def test_category_property(self, platform: Platform):
        """Test category property."""
        assert platform.category == platform.gates.category
    ...
    def test_get_element_with_gate(self, platform: Platform):
        ...
        gates = platform.gates.gates.keys()
