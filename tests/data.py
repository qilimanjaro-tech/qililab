    ...
    buses = [
        {
            ...
            Category.SYSTEM_CONTROL.value: {
                ...
                RUNCARD.INSTRUMENTS: [
                    {"alias": InstrumentName.QBLOX_QCM.value, "outputs": [0]},
                    {"alias": "rs_0", "outputs": [0]},
                ],
            },
        ...
        },
        {
            ...
            Category.SYSTEM_CONTROL.value: {
                ...
                RUNCARD.CATEGORY: Category.SYSTEM_CONTROL.value,
                RUNCARD.INSTRUMENTS: [
                    {"alias": InstrumentName.QBLOX_QRM.value, "outputs": [0]},
                    {"alias": "rs_1", "outputs": [0]},
                ],
            },
    ...
    buses = [
        {
            ...
            Category.SYSTEM_CONTROL.value: {
                ...
                RUNCARD.NAME: SystemControlName.READOUT_SYSTEM_CONTROL,
                RUNCARD.CATEGORY: Category.SYSTEM_CONTROL.value,
                RUNCARD.INSTRUMENTS: [{"alias": InstrumentName.KEYSIGHT_E5080B.value, "outputs": [0]}],
            },
            NodeName.PORT.value: 1,
        },
        {
            ...
            Category.SYSTEM_CONTROL.value: {
                ...
                RUNCARD.NAME: SystemControlName.READOUT_SYSTEM_CONTROL,
                RUNCARD.CATEGORY: Category.SYSTEM_CONTROL.value,
                RUNCARD.INSTRUMENTS: [{"alias": InstrumentName.AGILENT_E5071B.value, "outputs": [0]}],
            },
            NodeName.PORT.value: 0,
        },
    ]
