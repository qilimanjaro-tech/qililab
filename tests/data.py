...
class SauronVNA:
    ...
    buses = [
        {
            RUNCARD.ID: 0,
            RUNCARD.NAME: BusName.CONTINUOUS_READOUT_BUS,
            RUNCARD.CATEGORY: Category.BUS.value,
            RUNCARD.BUS_CATEGORY: BusCategory.CONTINUOUS.value,
            RUNCARD.BUS_SUBCATEGORY: BusSubCategory.CONTINUOUS_READOUT.value,
            RUNCARD.ALIAS: "keysight_e5080b_readout_bus",
            Category.SYSTEM_CONTROL.value: {
                RUNCARD.ID: 0,
                RUNCARD.NAME: SystemControlName.CONTINUOUS_READOUT_SYSTEM_CONTROL,
                RUNCARD.CATEGORY: Category.SYSTEM_CONTROL.value,
                RUNCARD.SYSTEM_CONTROL_CATEGORY: SystemControlCategory.CONTINUOUS.value,
                RUNCARD.SYSTEM_CONTROL_SUBCATEGORY: SystemControlSubCategory.CONTINUOUS_READOUT.value,
            },
            NodeName.PORT.value: 1,
        },
    ]
