...
class Galadriel:
    ...
    qblox_qcm_0: dict[str, Any] = {
        ...
        AWGTypes.FILTERS:[
            {   "output_id": 0,
                Parameter.EXPONENTIAL_AMPLITUDE_0.value: 0.7,
                Parameter.EXPONENTIAL_TIME_CONSTANT_0.value: 200,
                Parameter.EXPONENTIAL_STATE_0.value: DistortionState.ENABLED,
            ...
            {   "output_id": 1,
                Parameter.EXPONENTIAL_AMPLITUDE_0.value: 1,
                Parameter.EXPONENTIAL_TIME_CONSTANT_0.value: 20,
                Parameter.EXPONENTIAL_STATE_0.value: DistortionState.BYPASSED,
                Parameter.FIR_COEFF.value: [0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4],
                Parameter.FIR_STATE.value: DistortionState.ENABLED,
            },
            {   "output_id": 3,
                Parameter.EXPONENTIAL_AMPLITUDE_0: 0.1,
                Parameter.EXPONENTIAL_TIME_CONSTANT_0: 2000,
                Parameter.EXPONENTIAL_STATE_0: DistortionState.DELAY_COMP,
