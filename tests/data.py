...
class QMQDacII:
    ...
    instruments = [qmm, qdevil_qdac2]
    instrument_controllers = [qmm_controller, qdevil_qdac2_controller]

    buses: list[dict[str, Any]] = [
        {RUNCARD.ALIAS: "drive", RUNCARD.INSTRUMENTS: ["qmm"], RUNCARD.CHANNELS: ["drive"]},
        {RUNCARD.ALIAS: "readout", RUNCARD.INSTRUMENTS: ["qmm"], RUNCARD.CHANNELS: ["readout"]},
        {RUNCARD.ALIAS: "qdac_bus_1", RUNCARD.INSTRUMENTS: ["qdac"], RUNCARD.CHANNELS: [1]},
        {RUNCARD.ALIAS: "qdac_bus_2", RUNCARD.INSTRUMENTS: ["qdac"], RUNCARD.CHANNELS: [2]},
    ]
